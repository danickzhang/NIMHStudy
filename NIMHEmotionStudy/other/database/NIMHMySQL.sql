...
-- Thu 02 Jul 2015 10:34:02 AM CDT
...
CREATE TABLE IF NOT EXISTS `survey` (
  ...
  `name` TEXT NOT NULL COMMENT 'The display name for the survey i.e. Morning Survey	',
...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `type` TEXT NULL COMMENT 'The type of data reported by this event.  This value determines which foreign key to use to obtain the events information.',
